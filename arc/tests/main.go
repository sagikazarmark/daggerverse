...
import (
	"context"
	"dagger/arc/tests/internal/dagger"
	"fmt"
	"slices"
...
func (m *ArchiveFiles) Tar(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.Tar() })
}

func (m *ArchiveFiles) TarBr(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarBr() })
}

func (m *ArchiveFiles) TarBz2(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarBz2() })
}

func (m *ArchiveFiles) TarGz(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarGz() })
}

func (m *ArchiveFiles) TarLz4(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarLz4() })
}

func (m *ArchiveFiles) TarSz(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarSz() })
}

func (m *ArchiveFiles) TarXz(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarXz() })
}

func (m *ArchiveFiles) TarZst(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.TarZst() })
}

func (m *ArchiveFiles) Zip(ctx context.Context) error {
	return m.test(ctx, func(a *dagger.ArcArchive) *dagger.File { return a.Zip() })
}

func (m *ArchiveFiles) test(ctx context.Context, callback func(*dagger.ArcArchive) *dagger.File) error {
...
func (m *ArchiveDirectory) test(ctx context.Context, callback func(*dagger.ArcArchive) *dagger.File) error {
	dir := dag.CurrentModule().Source().Directory("./testdata")
